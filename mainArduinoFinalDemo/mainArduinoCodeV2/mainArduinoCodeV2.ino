...
if (analogRead(moisturePin)<=90)
{moistureValue = 10;}
if (analogRead(moisturePin)<=180)
{moistureValue = 20;}
if (analogRead(moisturePin)<=270)
{moistureValue = 30;}
if (analogRead(moisturePin)<=360)
{moistureValue = 40;}
if (analogRead(moisturePin)<= 450)
{moistureValue = 50;}
if (analogRead(moisturePin)<=540)
{moistureValue = 60;}
if (analogRead(moisturePin)<=630)
{moistureValue = 70;}
if (analogRead(moisturePin)<=720)
{moistureValue=80;}
if (analogRead(moisturePin)<=810)
{moistureValue=90;}
if (analogRead(moisturePin)<=900)
{moistureValue=100;}
}
